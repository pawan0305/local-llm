...
alias qwencodereview="cd ~/Local\ LLM && claude 'Review the most recent qwencode sessions. Check ~/.claude/projects/-home-pawan/ for the latest JSONL files, read what qwencode did, flag any tool refusals, empty responses, loops, or quality issues, and suggest concrete improvements to the litellm config or qwen3.sh.'"
alias hermesreview="cd ~/Local\ LLM && claude 'Review the Hermes agent setup and recent activity. Check ~/.hermes/logs/ for recent sessions, verify ~/.hermes/config.yaml points to localhost:6970, check SOUL.md, and suggest improvements to make Hermes more effective with local Qwen3.6.'"
ALIASES
...
echo "║  qwencodereview  — real Claude reviews qwencode sessions ║"
echo "║  startgemma      — start SuperGemma4 (port 6969)         ║"
echo "║  gemmacode       — Claude Code via SuperGemma4           ║"
echo "║  hermesreview    — real Claude reviews Hermes sessions   ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo ""
